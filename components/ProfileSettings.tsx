...
export function ProfileSettings({
  ...
  return (
    <div className="space-y-5 pb-28">
      ...
      {/* Mascot App Card */}
      <div className={`flex items-center gap-3.5 p-4 rounded-3xl border ${
        ...
        <img
          src="/icon-192.png"
          alt="Kalorix Logo"
          className="w-14 h-14 rounded-2xl object-contain bg-emerald-500/10 p-1 border border-emerald-500/20 shadow-sm shrink-0"
        />
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-[17px] font-extrabold tracking-tight">Kalorix Fitatu</h3>
            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-500 border border-emerald-500/20">
              v2.0
            </span>
          </div>
          <p className={`text-[12px] mt-0.5 ${dark ? "text-zinc-400" : "text-gray-500"}`}>
            Baza ponad 200+ produktów, skaner kodów kreskowych i asystent AI
          </p>
        </div>
      </div>
